<script lang="ts">
	...
	let { item, isDragging, isSelected, onDragStart, onSelect, onDelete }: Props = $props();
...
<article
	...
	style:outline={isSelected ? `2px solid ${EXISTS_COLOR}` : null}
>
	...
	<div class="absolute bottom-2 right-2 z-20">
		<button
			class="delete-btn flex h-5 w-5 cursor-pointer items-center justify-center rounded-full"
			style="color: {theme.existsColor};"
